...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("/policy-rules/{rule_id}/check-steps", "get", "200", False),
        ("/policy-rules/{rule_id}", "patch", "200", True),
        ("/policy-check-steps", "post", "201", True),
        ("/policy-check-steps", "get", "200", False),
        ("/policy-check-steps/{step_id}", "get", "200", False),
        ("/policy-check-steps/{step_id}", "patch", "200", True),

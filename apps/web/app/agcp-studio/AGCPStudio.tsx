...
const PS_TEMPLATES = [
  ...
  { cls:"ps2-tc-risk",     name:"Risk Threshold Trigger",  desc:"Trigger policy checks when the action risk score exceeds a defined threshold.", tags:["risk","conditional"] },

...
const requiredText = [
  ...
  "AGCP stores and evaluates governance metadata.",
  "AGCP does not inspect raw source content by default.",
  "AGCP does not certify legal compliance.",
  "Data Sources",
  "Data Usage Profiles",
  "Access Grants",
  "Models",
  ...
  "Policy repository",
  "Local backend",
  "Policies and folders load from the AGCP backend.",
  "Search policies",
  "Templates",
  "New policy",
  "New folder",
  "New policy folder name",
  "Create folder",
  "Rename folder",
  "Delete empty folder",
  "Confirm delete",
...
function runRootDashboardSmoke() {
  const rootRequiredText = [
    ...
    "Govern agents running in external runtimes",
    ...
    "Human approvals",
    "Evidence bundle",
    "Recent policy and approval work",
    "Policy Studio",
    "sidebar-rail",
    "sidebar-sidepanel",
    "overview-no-rail",
